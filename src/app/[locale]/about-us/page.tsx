...
export default async function AboutUsPage({ params }: PageProps) {
  ...
  try {
    ...
    console.error('Error reading about-us Framer files:', error);
    return <div className="p-8 text-center text-red-500 font-bold">Error loading About Us page.</div>;
  }
