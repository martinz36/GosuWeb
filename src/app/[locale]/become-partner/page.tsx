...
export default async function BecomePartnerPage({ params }: PageProps) {
  ...
  const key = `become_partner_${activeLocale}`;
  ...
  try {
    ...
    console.error('Error reading become-partner Framer files:', error);
    return <div className="p-8 text-center text-red-500 font-bold">Error loading Become a Partner page.</div>;
  }
