...
export default async function HomePage({ params }: PageProps) {
  ...
  try {
    ...
    console.error('Error reading homepage Framer files:', error);
    return <div className="p-8 text-center text-red-500 font-bold">Error loading homepage design.</div>;
  }
