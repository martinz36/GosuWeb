...
export default async function StoresPage({ params }: PageProps) {
  ...
  const key = `stores_${activeLocale}`;
  ...
  try {
    ...
    console.error('Error reading stores Framer files:', error);
    return <div className="p-8 text-center text-red-500 font-bold">Error loading Stores page.</div>;
  }
